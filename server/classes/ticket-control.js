...
class TicketControl {
    ...
    attendTicket(desktop) {
        ...
        this.tickets.shift(); // delete the first position from the array

        let attendTicket = new Ticket(numberTicket, desktop);

        this.last4.unshift(attendTicket); // add to the beginning to the array
    ...
    restartCounting() {
        ...
        console.log('The system was initialized');
        this.saveFile();
